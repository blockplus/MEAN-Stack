...
( function() {
	...
	angular.module("com.mondayreplay.api.enduser.Track", ["ngCookies", "Lib.Services.Config"])
		.factory("Track", ["$http", "$cookies", "$q", "Config", function ($http, $cookies, $q, Config) {
			var dataFactory = {};

			dataFactory.tracksBySessionId = function (sessionId, start, limit, output, error) {
				var req = {
					method: "POST",
					url: Config.API_URL + "/enduser/track/tracksbysessionid",
					headers: {
			...
			dataFactory.tracksBySessionIdPromise = function (sessionId, start, limit) {
				var req = {
					method: "POST",
					url: Config.API_URL + "/enduser/track/tracksbysessionid",
					headers: {
			...
			dataFactory.delete = function (id, output, error) {
				var req = {
					method: "POST",
					url: Config.API_URL + "/enduser/track/delete",
					headers: {
						"X-CLIENT-TYPE" : "AngularJS"
						,"X-CLIENT-VERSION" : "1.10.0"
						,"X-CLIENT-VERSION-CODE" : "1"
